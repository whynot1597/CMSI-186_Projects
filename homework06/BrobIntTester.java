...
public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "    Test 015: Adding g11 and g13 [10 + 234567]: " );
         System.out.println( "      expecting: 234577 and got " + g11.add( g13 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 016: Adding g13 and g11 [234567 + 10]: " );
      ...
      try {
         System.out.println( "    Test 019: Adding g14 and g15 [-234567 + -10]: " );
         System.out.println( "      expecting: -234577 and got " + g14.add( g15 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 020: Adding g15 and g14 [-10 + -234567]: " );
      ...
      try {
         System.out.println( "    Test 022: Adding g14 and g16 [-234567 + -999999]: " );
         System.out.println( "      expecting: -1234566 and got " + g14.add( g16 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 023: Adding g16 and g14 [-999999 + -234567]: " );
      ...
      try {
         ...
         System.out.println( "      expecting: 1 and got: " + g1.compareTo( g3 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n    Test 028: Checking compareTo() method on g3 and g1: "  );
         System.out.println( "      expecting: -1 and got: " + g3.compareTo( g1 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n    Test 029: Checking compareTo() method on g3 and g4: "  );
         System.out.println( "      expecting: 1 and got: " + g3.compareTo( g4 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
