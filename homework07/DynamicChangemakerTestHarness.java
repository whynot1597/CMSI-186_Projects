 ...
 * @author    :  Professor Don Murphy (prototype)
 * @author    :  B.J. Johnson totally ripped off from the original (prototype)
 * Date       :  2017-04-19 (prototype)
 * @author    :  Jeremy Goldberg
 * Date       :  2018-05-03
 * Description:  This program provides a test harness for running tests to verify correct operation of the
